...
exports.parseRaidSchedule = parseRaidSchedule;
exports.createCalendarEvent = createCalendarEvent;
exports.updateRaidCalendar = updateRaidCalendar;
 ...
 */
function parseRaidSchedule(scheduleText) {
    const events = [];
 ...
 */
function createCalendarEvent(raidEvent) {
 ...
 */
async function getExistingEvents(startDate, endDate, calendarId) {
    try {
 ...
 */
async function updateRaidCalendar(scheduleText, calendarId) {
    try {
